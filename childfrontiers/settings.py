"""
Django settings for childfrontiers project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '3&ex_!(gei+-6p3xpn82@gr_()k6c@bf95x3$%vz1!jj1smjvh')
...
ROOT_URLCONF = 'childfrontiers.urls'
...
# Sends emails to console. Email backend not yet configured.
